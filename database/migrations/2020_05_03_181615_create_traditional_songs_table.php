...
class CreateTraditionalSongsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('traditional_songs', function (Blueprint $table) {
            ...
            $table->tinyInteger('status')->nullable(); //Status 0:pending, 1:active, 2:reject
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('traditional_songs');
    }
}
