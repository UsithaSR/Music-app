...
class CreateKnowledgeHubVideosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('knowledge_hub_videos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('knowledge_hub_videos');
    }
}
