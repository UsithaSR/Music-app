...
class KnowledgeHubImagesTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('knowledge_hub_images')->truncate();
        DB::table('knowledge_hub_images')->insert([
            [
                'title_en' => "image_1",
                'title_si' => "සිංදුව_1",
                'title_ta' => "பாடல்_1",
                'image' => "https://archives.dailynews.lk/2010/07/21/z_Art-page-17-Magnificence03.jpg",
