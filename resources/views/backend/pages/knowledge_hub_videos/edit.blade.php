            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> Update Knowledge Hub Video</h4>
                    </div>
                    <div class="card-body">
                        <form id="traditional_song_update" method="post"
                              action="{{ route('backend.knowledge_hub_videos.update', $knowledge_hub_video->id) }}"
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control"
                                               value="{{ old('title_en',$knowledge_hub_video->title_en) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_si" class="form-control"
                                               value="{{ old('title_si',$knowledge_hub_video->title_si) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ta" class="form-control"
                                               value="{{ old('title_ta',$knowledge_hub_video->title_ta) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img"
                                             src="{{$knowledge_hub_video !=null?$knowledge_hub_video->video_thumbnail:asset('assets/img/dummy.jpg')}}">
                                        <input type="file" class="custom-file-input" name="video_thumbnail"
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="video" class="form-control"
                                               value="{{ old('video',$knowledge_hub_video->video) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_en" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_en',$knowledge_hub_video->content_en) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_si" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_si',$knowledge_hub_video->content_si) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_ta" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_ta',$knowledge_hub_video->content_ta) }}</textarea>
