...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="traditional_game_update" method="post" action="{{ route('backend.traditional_games.update', $traditional_game->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control" value="{{ old('title_en',$traditional_game->title_en) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_si" class="form-control" value="{{ old('title_si',$traditional_game->title_si) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ta" class="form-control" value="{{ old('title_ta',$traditional_game->title_ta) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img" src="{{$traditional_game->image_thumbnail !=null?$traditional_game->image_thumbnail:('assets/img/dummy.jpg')}}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img2" src="{{$traditional_game->image!=null?$traditional_game->image:('assets/img/dummy.jpg')}}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_en" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_en',$traditional_game->content_en) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_si" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_si',$traditional_game->content_si) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_ta" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_ta',$traditional_game->content_ta) }}</textarea>
    ...
    {{--    {!! JsValidator::formRequest('App\Http\Requests\CMS\AdCreateRequest', '#traditional_game_update') !!}--}}
@endsection
