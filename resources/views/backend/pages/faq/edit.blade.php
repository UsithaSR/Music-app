        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="traditional_song_update" method="post" action="{{ route('backend.faq.update', $faq->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control" value="{{ old('title_en',$faq->title_en) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_si" class="form-control" value="{{ old('title_si',$faq->title_si) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ta" class="form-control" value="{{ old('title_ta',$faq->title_ta) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_en" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_en',$faq->content_en) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_si" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_si',$faq->content_si) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_ta" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_ta',$faq->content_ta) }}</textarea>
