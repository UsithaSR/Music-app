            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> Create Knowledge Hub Image</h4>
                    </div>
                    <div class="card-body">
                        <form id="traditional_song_create" method="post" action="{{ route('backend.knowledge_hub_images.store') }}" enctype="multipart/form-data">
                            @csrf
