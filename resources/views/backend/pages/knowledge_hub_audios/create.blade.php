            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> Create Knowledge Hub Audio</h4>
                    </div>
                    <div class="card-body">
                        <form id="traditional_song_create" method="post"
                              action="{{ route('backend.knowledge_hub_audios.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img"
                                             src="{{asset('assets/img/audio-icon.png')}}">
