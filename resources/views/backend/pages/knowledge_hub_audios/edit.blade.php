            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> Update Knowledge Hub Audio</h4>
                    </div>
                    <div class="card-body">
                        <form id="traditional_song_update" method="post"
                              action="{{ route('backend.knowledge_hub_audios.update', $knowledge_hub_audio->id) }}"
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control"
                                               value="{{ old('title_en',$knowledge_hub_audio->title_en) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_si" class="form-control"
                                               value="{{ old('title_si',$knowledge_hub_audio->title_si) }}">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ta" class="form-control"
                                               value="{{ old('title_ta',$knowledge_hub_audio->title_ta) }}">
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        <label class="d-block" for="title">{{__(" Audio")}}</label>
                                        <img class="gal-img prev_img" id="prev_img"
                                             src="{{$knowledge_hub_audio !=null?$knowledge_hub_audio->audio:('assets/img/audio-icon.png')}}">
                                        <input type="file" class="custom-file-input" name="audio_thumbnail"
                                               id="custom-file-input">
                                        @include('backend.alerts.feedback', ['field' => 'audio'])
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img"
                                             src="{{$knowledge_hub_audio !=null?$knowledge_hub_audio->image_thumbnail:('assets/img/dummy.jpg')}}">
                                        <input type="file" class="custom-file-input" name="audio_thumbnail"
                                               id="custom-file-input">
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_en" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_en',$knowledge_hub_audio->content_en) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_si" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_si',$knowledge_hub_audio->content_si) }}</textarea>
                                ...
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="10" type="text" name="content_ta" class="form-control"
                                                  style="border:1px solid #E3E3E3">{{ old('content_ta',$knowledge_hub_audio->content_ta) }}</textarea>
