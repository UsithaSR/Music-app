            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title"> Update Hand Work Image</h4>
                    </div>
                    <div class="card-body">
                        <form id="hand_work_image_create" method="post" action="{{ route('backend.hand_work_images.update',$hand_work_image->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="hand_work_id" name="hand_work_id">
                                            @foreach($hand_works as $hand_work)
                                                <option value="{{$hand_work->id}}"{{$hand_work->id==$hand_work_image->hand_work_id?"selected":""}}>{{$hand_work->title_en}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-7 pr-1">
                                    <div class="form-group">
                                        ...
                                        <img class="gal-img prev_img" id="prev_img" src="{{$hand_work_image->image!=null?$hand_work_image->image:asset('assets/img/dummy.jpg')}}">
